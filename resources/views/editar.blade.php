                        ...
                        <form action="{{route('guardar-producto')}}" method="POST">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control  @error('nombre') is-invalid @enderror" name="nombre" value="{{old('nombre', $producto->nombre) }}" id="input_nombre" placeholder="Nombre">
                                @error('nombre')
                              ...
                              <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" value="{{old('descripcion',$producto->descripcion) }}" id="input_descripcion" placeholder="Descripcion">
                                @error('descripcion')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
